...
class CatLandGenerator extends \yii\bootstrap\Widget
{
    ...
    public function renderContent()
    {
        ...
        $prod = PartnersProducts::find()
            ->select('products.products_id as prod, products.products_price as price, products.products_last_modified as last, products_date_added as add_date,products_quantity as quantity ')
            ...
            ->distinct()->orderBy('products_date_added')->asArray()->all();
        $ifht = 0;
