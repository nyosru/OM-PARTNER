...
class ProductCard extends \yii\bootstrap\Widget
{
    ...
    public function init()
    {
        ...
        $product_menu = '<a class="product-menu" style="display: block;cursor:pointer;float: left;padding-right: 10px;"><i class="mdi" style="border-radius: 40px; border: 2px solid rgb(0, 165, 161); padding: 0px; margin: 0px; font-size: 16px;width: 20px;" aria-hidden="true"><noindex>more_horiz</noindex></i></a><div class="product-menu-rel active" style="display:none"><div>'. $product['products_ordered'].'</div><a href="'.BASEURL.'/catalog?cat='.$this->category.'"><noindex>Категория: </noindex>'.$categ.'</a></div>';
