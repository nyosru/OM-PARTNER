...
<body>
    ...
    <div class="wrap">
        ...
        <div class="col-lg-5 navbar-form navbar-left" role="search" style="width: 26%;">
            ...
            <div class="result_search_word"></div>
            </div>
...
<div style="margin: 0% 25%; float: left;">
   ...
   ;?>
    ...
    <script type="text/javascript">
        var _tmr = _tmr || [];
        _tmr.push({id: "2698708", type: "pageView", start: (new Date()).getTime()});
        (function (d, w, id) {
