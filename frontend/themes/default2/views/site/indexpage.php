...
if ($this->beginCache('partner-index'.$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI] , array('duration'=>600))) {?>
    ...
    <div class="container-fluid" id="partners-main-right-back">
        <div id="partners-main-right" class="bside">
            <div id="main-index">
                <div id="index-card-5" class="data-j index-card" data-cat="1720"><a href="/site/catalog#!cat=<?  echo  implode('.',$functions->load_cat($cat_array[cat], 1720, $cat_array[name], $check));?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/7.jpg"></a></div>
                <div id="index-card-6" class="data-j index-card" data-cat="2008"><a href="/site/catalog#!cat=<?  echo   implode('.',$functions->load_cat($cat_array[cat], 2008, $cat_array[name], $check))?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/1.jpg"></a></div>
                <div id="index-card-6" class="data-j index-card" data-cat="2047"><a href="/site/catalog#!cat=<?  echo   implode('.',$functions->load_cat($cat_array[cat], 2047, $cat_array[name], $check))?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/2.jpg"></a></div>
                <div id="index-card-6" class="data-j index-card" data-cat="1762"><a href="/site/catalog#!cat=<?  echo  implode('.',$functions->load_cat($cat_array[cat], 1762, $cat_array[name], $check))?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/5.jpg"></a></div>
                <div id="index-card-3" class="sort data-j index-sort" data="10"><a href="/site/catalog#!cat=<?   echo   implode('.',$functions->load_cat($cat_array[cat], 932, $cat_array[name], $check) )?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/6.jpg"></a></div>
                <div id="index-card-6" class="data-j index-card" data-cat="1836"><a href="/site/catalog#!cat=<?  echo   implode('.',$functions->load_cat($cat_array[cat], 1836, $cat_array[name], $check))?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/3.jpg"></a></div>
                <div id="index-card-6" class="data-j index-card" data-cat="2066"><a href="/site/catalog#!cat=<?  echo  implode('.', $functions->load_cat($cat_array[cat], 2066, $cat_array[name], $check))?>&count=20&start_price=&end_price=1000000&prod_attr_query=&page=undefined&sort=0&searchword="><img src="/images/banners/4.jpg"></a></div>
            </div>
            <div id="main-spec">
