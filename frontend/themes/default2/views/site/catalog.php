                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data[0] != 'Не найдено!') {
                                ...
                                $headbside += '<div id="count-display"> | Показывать по<div class="count data-j"> <a class="countdisplay" onclick="" data-j="on" data-count="20"  href="' + new_url(new_suburl(split_url($url), 'count', '20')) + '">20</a></div><div class="count data-j"> <a data-j="on" class="countdisplay" onclick="" data-count="50" href="' + new_url(new_suburl(split_url($url), 'count', '50')) + '">50</a></div> </div> <div class="count data-j"> <a class="countdisplay" onclick="" data-j="on" data-count="100" href="' + new_url(new_suburl(split_url($url), 'count', '100')) + '">100</a>  <a class="countdisplay" onclick="" data-j="on" data-count="200" href="' + new_url(new_suburl(split_url($url), 'count', '200')) + '">200</a> <a class="countdisplay" onclick="" data-j="on" data-count="500" href="' + new_url(new_suburl(split_url($url), 'count', '500')) + '">500</a> <a class="countdisplay" onclick="" data-j="on" data-count="1000" href="' + new_url(new_suburl(split_url($url), 'count', '1000')) + '">1000</a> </div>';
                            ...
                            if (typeof data[16] != 'undefined' && typeof (data[16][0] != 'undefined')) {
            ...
            <? } else {
                ...
                if ($data[0] != 'Не найдено!') {
                    ...
                    if (is_array($data[16])) {
                        ...
                        $this->title = $data[16] . '-' . (intval($data[10]) + 1);
                    }
                    echo $innerhtml;
                    echo $downnav;
                } else {
