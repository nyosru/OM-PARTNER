...
<?php $this->beginPage() ?>
    ...
    <header class="header-container">
        ...
        <div class="container" id="partners-main" >
            <div class="container" id="partners-main-left-back" style="margin-bottom: 60px;padding-top: 180px; float: left">
            ...
            <div class="container-fluid" id="partners-main-right-back" style="padding-top: 180px;">
