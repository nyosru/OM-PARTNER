...
?>
    ...
    <body
        style="font-family: Open Sans,Helvetica Neue,sans-serif; font-style: normal; font-weight: 300; min-width: 1280px; margin-left: auto; margin-right: auto; height: 100%; ">
    <?php $this->beginBody(); ?>
    <div class="wrap">
        <?php
            ...
            <div class="partners-main-left-back">
                ...
                <div>
                    <div class="partners-main-left suplogo"
                         style="max-width: 316px;height: 55px;background: #F5F5F5; position: fixed; width: 16.5%; z-index: 100; min-width: 211px;">
                ...
                <div class="partners-main-left-cont"
                     style="height: 55px; border-bottom: 1px solid rgb(204, 204, 204);max-width: 316px;">
...
//                                ])->label('Введите текст на картинке');
                ...
                <footer class="footer">
                    ...
                    <div class="" style="margin: 0px 25px;">
                            ...
                            if (isset(Yii::$app->params['partnersset']['mailcounter']['value']) && Yii::$app->params['partnersset']['mailcounter']['active'] == 1) {
                                ...
                                <noscript>
                                    <div style="position:absolute;left:-10000px;">
                                        <img src="//top-fwz1.mail.ru/counter?id=' . $mailcounter . ';js=na"
                                             style="border:0;"
                        ...
                        <? //= BASEURL ?><!--/offerta">Оферта</a> <a-->
                        <!--                        href="--><? //= BASEURL ?><!--/paying">Оплата</a> <a-->
                        <!--                        href="--><? //= BASEURL ?><!--/delivery">Доставка</a> <a href="-->
                        <? //= BASEURL ?><!--/contacts">Контакты</a></p>-->
                    </div>
                </footer>
            </div>
        </div>
