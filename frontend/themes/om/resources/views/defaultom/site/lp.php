    ...
    <div class="col-md-12" style="background: #fcfcfc none repeat scroll 0% 0%; font-size: 1vw; text-align: center; margin: 5vh 0px;">
        ...
        <div class="collapse" id="collapsenext">
            <div style="text-align: left; margin: 10px 0px;">
                ...
                <div class="item4">
                    При отправке ТК Энергия, рекомендуем Вам выбирать способ упаковки "коробка", т.к по правилам перевозки ТК сборного груза, упаковка должна быть жесткая, в противном случае за повреждение груза ответсвенность ТК Энергия не несет
                </div>
            </div>
        </div>
                ...
                <div id="collapse1" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="col-md-4 mid3-item">
                            ...
                            <div class="item4">
                                Минимальная сумма первого заказа 5000 тысяч рублей. Все последующие заказы набираются от 1500 рублей. Если после редактирования нами Вашего заказа итоговая стоимость стала меньше 5000р., заказ в любом случае будет отправлен Вам сразу же после оплаты. К уже оформленному заказу Вы можете оформить Дозаказ на сумму от 1500 руб. (Дозаказ осуществляется так же, как обычный Заказ, с комментарием о том, что это Дозаказ). Поштучно можно заказывать любой товар, кроме того, который продается упаковками  </div>
                        </div>
                        <div class="col-md-4 mid3-item">
                            <div class="item4">
                                Заказы оплаченные выборочно отправляются только после оплаты  предшествующих им неоплаченных заказов.
