...
$(document).on('ready', function () {
    ...
    $innerhtml = '<div id="modal-save-set" style="display:none">'+$modalsaveset+'</div><div id="overlay-save-cart"></div><form action="<?= BASEURL;?>/saveorder" method="post"><input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" /><div class="cart-top" style="width: 100%;height:40px;">Товары в моей корзине<div id="save-set"><i style="font-size:30px;line-height:0.6;color:#00a5a1;" title="Сохранить корзину" class="fa fa-cart-plus" aria-hidden="true"></i></div></div><div class="cart-column1" style="width: 48%;float:left;border:1px solid #ccc; border-radius: 4px; margin-right: 5px;">';
