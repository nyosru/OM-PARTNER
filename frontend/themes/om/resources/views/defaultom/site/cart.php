    ...
    if (JSON.parse(localStorage.getItem('cart-om'))) {
        ...
        $.each($i, function () {
            ...
            $innerhtml += '<div data-calc="'+$identypay+'" data-raw="' + ($c) + '" class="cart-row" style="float: left; height: auto; margin: 0px; border-bottom: 1px solid rgb(204, 204, 204); width: 100%; padding: 5px;">' +
                ...
                '<div class="cart-image" style="float: left; width:120px;"><a target="_blank" href="<?=BASEURL?>/product?id='+requestdata.responseJSON.product.products_id+'"><img style="width: 100%; max-height:100%;" src="<?=BASEURL;?>/imagepreview?src=' + requestdata.responseJSON.product.products.products_id + '"/></a></div>' +
