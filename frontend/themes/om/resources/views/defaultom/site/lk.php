...
<script>
    $(document).on('ready', function() {
        ...
        function  onAjaxProfileSuccessinfo(data) {
            ...
            $inner +='<button class="btn btn-sm btn-info profile-orders" id="profile-orders" style="bottom: 0px; position: relative; float: right;margin-left: 10px;">Оставить без изменений</button><button class="save-user-profile btn btn-sm btn-info" style="bottom: 0px; position: relative; float: right;">Сохранить</button>';
