...
foreach ($figuresprovider as $value) {
    echo '<div class="days_raw'.$i++.'">';
    echo '<div class="days-group">
    ...
    foreach ($value['products'] as $k=>$v) {
        ...
        echo '<div class="days-prod' . $k . '" style="width:250px; height:450px;float:left;overflow:hidden;">
                <div class="days-prod' . $k . '-card">';
        $innerhtml = '';
