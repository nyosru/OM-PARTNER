...
?>
    ...
    <div id="" style="font-size: 20px; font-weight: 400; float: left; margin: 5px;">Новости</div>
        <a id="" href="<?= BASEURL.'/news'?>" style="display: block; font-size: 14px; font-weight: 400; float: right; color: rgb(0, 165, 161); margin: 0px 20px; padding: 10px;">Все Новости</a>
    <div style="margin: 0px 5px; float: left; width: 100%;">
       <?= \frontend\widgets\NewsBlockOM::widget()?>
    </div>
    </div>
    <div style="float: left;width: 33.333%;"><div style="background: rgb(204, 204, 204) none repeat scroll 0% 0%; height: 200px; text-align: center; padding: 90px; margin: 5px;">Баннер ВК</div></div>
    <div style="float: left;width: 33.333%;"><div style="background: rgb(204, 204, 204) none repeat scroll 0% 0%; height: 200px; text-align: center; padding: 90px; margin: 5px;">Баннер ОК</div></div>
    </div>
