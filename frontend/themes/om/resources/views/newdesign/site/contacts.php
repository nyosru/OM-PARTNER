...
<div class="container">
    <div style="margin: 20px 0;">
        <p>
            Уважаемые клиенты! Используя приведенные ниже возможности
            ...
            графику: c 8.00 до 20.00 7 дней в неделю и в праздники. Письменные обращения принимаются 24 часа в сутки, 7
            дней в
        ...
        <p>
            Администрация "Одежда-Мастер" будет признательна Вам за предложения по улучшению
            нашей работы и объективные отзывы о работе сотрудников Контактного Центра.
        </p>
        ...
        <div class="row">
            <div class="col-sm-4">
                <table border="0">
                    <tr>
                        <td width="100" align="center"><i class="fa fa-phone-square "
                                                          style="font-size: 50px; color: rgb(0, 165, 161); text-shadow: 1px 1px 1px rgb(204, 204, 204);"></i>
                        </td>
                    ...
                    <tr>
                        <td align="center"><i class="fa fa-skype"
                                              style="font-size: 50px; color: rgb(0, 165, 161); text-shadow: 1px 1px 1px rgb(204, 204, 204);"></i>
                        </td>
                    ...
                    <tr>
                        <td align="center"><i class="fa fa-phone-square "
                                              style="font-size: 50px; color: rgb(0, 165, 161); text-shadow: 1px 1px 1px rgb(204, 204, 204);"></i>
                        </td>
            ...
            <div class="col-sm-6">
                ...
                echo Html::submitButton('Отправить', ['class' => 'button', 'name' => 'save_lk', 'value' => 'user']);
                ActiveForm::end();
