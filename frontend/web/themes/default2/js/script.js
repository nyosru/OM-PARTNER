    ...
    $.ajax({
        ...
        success : function(data) {
            ...
            if (data[0] != 'Не найдено!') {
                ...
                $headbside += '<div id="count-display"> | Показывать по<div class="count data-j"> <a class="countdisplay" onclick="" data-j="on" data-count="100"  href="/site/catalog'+new_url(new_suburl(split_url($url), 'count', '100'))+'">100</a></div><div class="count data-j"> <a data-j="on" class="countdisplay" onclick="" data-count="200" href="/site/catalog'+new_url(new_suburl(split_url($url), 'count', '200'))+'">200</a></div> </div> <div class="count data-j"> <a class="countdisplay" onclick="" data-j="on" data-count="500" href="/site/catalog'+new_url(new_suburl(split_url($url), 'count', '500'))+'">500</a> </div>';
