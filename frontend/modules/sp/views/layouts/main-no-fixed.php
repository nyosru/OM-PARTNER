...
<body
    style="background:#FFF;font-family: Roboto,Helvetica Neue,sans-serif;font-style: normal;font-weight: 300;min-width: 1440px;color:#333;margin-left: auto;margin-right: auto;height: 100%;">
<?php $this->beginBody(); ?>
<div class="wrap">
    <?php
    if (
                ...
                <div
                    ...
                    <div style="width: 33%;position: relative;display: inline-block;height: 100%;">
                        <div style="margin: 25px;position: absolute;bottom: 0px;top: 0px;right: 0px;left: 0px;font-size: 18px;font-weight: 400;text-align: left;line-height: 32px;">
                            <a class="lksp-main-menu" href="/sp/default/orders">1</a>
                            <a class="lksp-main-menu" href="/sp/default/index">2</a>
                            <a class="lksp-main-menu" href="/sp/default/all-clients">3</a>
                            <a class="lksp-main-menu" href="/sp/default/orders-edit">4</a>
                            <a class="lksp-main-menu" href="/sp/default/common-orders">5</a>
                        </div>
                    </div>
                    <div style="width: 33%;position: relative;display: inline-block;height: 100%;">
                        <div
