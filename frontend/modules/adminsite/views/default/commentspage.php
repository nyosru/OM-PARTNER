    ...
    'columns' => [
        ...
        [
            ...
            'content' => function ($data) {
                   ...
                   return '<a href="/product?id='.$data->relate_id.'">'.$data->relate_id.'</a>';
        ...
        ['class' => 'yii\grid\ActionColumn',
            ...
            'buttons' => [
                'add' => function ($url, $model, $key) {
                    $url = Yii::$app->urlManager->createUrl(['/adminsite/default/commentscontrol', 'id' => $key, 'action' => 'add']);
                    return Html::a(
                        '<span class="fa fa-check" style="font-size: 20px; color: green; margin: 0px 10px;"></span>',
                        $url);
                },
                'hidden' => function ($url, $model, $key) {
                    $url = Yii::$app->urlManager->createUrl(['/adminsite/default/commentscontrol', 'id' => $key, 'action' => 'hidden']);
                    return Html::a(
