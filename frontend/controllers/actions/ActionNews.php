...
trait ActionNews
{
    public function actionNews()
    {
        ...
        $key = Yii::$app->cache->buildKey('partner-' . Yii::$app->params['constantapp']['APP_ID'] . '-newspagesawdawdssites-' . (integer)(Yii::$app->request->post('page')) . '-set-' .
            (integer)(Yii::$app->params['partnersset']['newsonindex']['value']));
