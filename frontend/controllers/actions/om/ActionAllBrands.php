...
trait ActionAllBrands
{
    public function actionAllbrands()
    {
        ...
        $brands =  Specifications::find()
            ...
            ->where([
                'specification_values.specifications_id'=>'77',
                'specification_values.specification_values_id'=>$brandsallow,
            ])
            ->andWhere(['not in','specification_values.specification_values_id',$unsetbrands])
            ->asArray()
            ->groupBy('specification_values_description.specification_values_id')
