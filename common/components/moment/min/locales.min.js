...
//! author : Robert Sedovšek : https://github.com/sedovsek
    ...
    function V(a) {
        ...
        return b > 0 && (e += _a[b] + "vatlh"), c > 0 && (e += ("" !== e ? " " : "") + _a[c] + "maH"), d > 0 && (e += ("" !== e ? " " : "") + _a[d]), "" === e ? "pagh" : e
    }
...
//! author : Werner Mollentze : https://github.com/wernerm
    var _ = (a.defineLocale("af", {
        ...
        week: {dow: 0, doy: 6}
    }), "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_")), Ra = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"), Sa = (a.defineLocale("nl", {
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 4}
    }), "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_")), Ta = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_"), Ua = (a.defineLocale("pl", {
        months: function (a, b) {
        ...
        week: {dow: 1, doy: 7}
    }), [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[й|я]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i]), Va = (a.defineLocale("ru", {
        months: {
    ...
    }), "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_")), Wa = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"), Xa = (a.defineLocale("sk", {
        months: Va,
        monthsShort: Wa,
        ...
        words: {
            ...
            var d = Ya.words[c];
            return 1 === c.length ? b ? d[0] : d[1] : a + " " + Ya.correctGrammaticalCase(a, d)
        }
    }), Za = (a.defineLocale("sr", {
        months: ["januar", "februar", "mart", "april", "maj", "jun", "jul", "avgust", "septembar", "oktobar", "novembar", "decembar"],
        monthsShort: ["jan.", "feb.", "mar.", "apr.", "maj", "jun", "jul", "avg.", "sep.", "okt.", "nov.", "dec."],
        ...
        calendar: {
            sameDay: "[Idag] LT", nextDay: "[Imorgon] LT", lastDay: "[Igår] LT", nextWeek: "[På] dddd LT",
        ...
        week: {dow: 1, doy: 7}
    }), {1: "௧", 2: "௨", 3: "௩", 4: "௪", 5: "௫", 6: "௬", 7: "௭", 8: "௮", 9: "௯", 0: "௦"}), $a = {
        "௧": "1",
        "௨": "2",
        "௩": "3",
        "௪": "4",
        ...
        week: {dow: 1, doy: 4}
    }), "pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_")), ab = (a.defineLocale("tlh", {
