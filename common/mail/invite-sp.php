...
<p style="text-align:center;margin:10px 0 30px 0;">
    ...
    <a href="http://<?=$_SERVER['HTTP_HOST'].BASEURL;?>/lk?<?=$contentutm;?>" target="_blank" style="font-weight:bold;text-decoration:underline;color:#007BC1;font-family:'Roboto', Arial;font-size:14px;"> этой ссылке</a> и дальше следовать указаниям на сайте.
</p>
