            ...
            <table width="800"
                        ...
                        <table bgcolor="#fff;" 
                            ...
                            <tr>
                                <td style="padding:10px 207px 10px 100px;width:100px; background-color: #00ca6d;">
                                    <h1>
                                        <a style="color:black; text-align: center" target=" _blank" href="http://<?= $site ?>">
                                            <?= $site_name ?>
                                        </a>
                                    </h1>
                                </td>
                ...
                <tr style="text-align:center;height:30px;">
                    <td style="font-size:14px;font-family:officinaserifcBook,sans-serif;">
                        <a style="margin-left:0px;color:#282828;" href="http://<?= $site ?>/site/news">
                            Новости
                        </a>
                        <a style="margin-left:8px;color:#282828;" href="http://<?= $site ?>/site/delivery">
                            Доставка
                        </a>
                        <a style="margin-left:8px;color:#282828;" href="http://<?= $site ?>/site/contacts">
                            Контакты
                        </a>
                        <a style="margin-left:8px;color:#282828;" href="http://<?= $site ?>/site/lk">
                            Личный кабинет
                        </a>
                        <a style="margin-left:8px;color:#282828;" href="http://<?= $site ?>/site/requestorders">
                            Ваши заказы
                        </a>
                    </td>
                </tr>
                                        ...
                                        <tr>
                                            <td style="padding-top:0;padding-bottom:0;" colspan="2">
                                                <p style="font-family:officinaserifcBook,sans-serif;font-size:20px;">
                                                    Статус Вашего заказа № <?= $id ?> от <?= $date_order ?> изменился. Новый статус: 
                                                    <span style="font-weight: bold">Ожидает оплаты</span>
                                                </p>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding-top:25px;padding-bottom:15px;">
                                                <p style="font-size:22px;font-family:officinaserifcBook,sans-serif;">
                                                    ...
                                                    <a href="http://<?= $site ?>/site/requestorders">
                                                        личном кабинете:
                                                    </a>
                                                </p>
                                            </td>
