                ...
                <tr style="text-align:center;height:30px;">
                    <td style="font-size:14px;font-family:officinaserifcBook,sans-serif;">
                        <a style="margin-left:0px;color:#282828;"
                           href="http://<?= $site ?>/site/news">
                            Новости
                        </a>
                        <a style="margin-left:8px;color:#282828;"
                           href="http://<?= $site ?>/site/delivery">
                            Доставка
                        </a>
                        <a style="margin-left:8px;color:#282828;"
                           href="http://<?= $site ?>/site/contacts">
                            Контакты
                        </a>
                        <a style="margin-left:8px;color:#282828;"
                           href="http://<?= $site ?>/site/lk">
                            Личный кабинет
                        </a>
                        <a style="margin-left:8px;color:#282828;"
                           href="http://<?= $site ?>/site/requestorders">
                            Ваши заказы
                        </a>
                    </td>
                </tr>
