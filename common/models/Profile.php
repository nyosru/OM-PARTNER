...
class Profile extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['password'], 'string', 'tooLong' => 'Максимум 40 символов', 'on' => 'chpass', 'tooShort' => 'Минимум 8 символов', 'min' => 8, 'max' => 40],
            [['password'], 'required', 'message' => 'Это обязательное поле', 'on' => 'chpass'],
...
//            $this->delivery[$key]['entryzones']=$value->entry_zone_id;
    ...
    {
        $user = \common\models\User::find()->where(['partners_users.id' => Yii::$app->user->getId(), 'partners_users.id_partners' => Yii::$app->params['constantapp']['APP_ID']])->joinWith('userinfo')->one();
