...
!function (t) {
    ...
    "use strict";
    t.fn.ratingLocales = {};
    var e, a, n, r, i, l, o, s, c;
    e = 0, a = 5, n = .5, r = function (e, a) {
        ...
        constructor: c, _parseAttr: function (t, i) {
            var o, s, c, u = this, g = u.$element, h = g.attr("type");
            if ("range" === h || "number" === h) {
                switch (s = l(g, t, i), t) {
                    case"min":
                        c = e;
            ...
            var e = r(t.pageX) ? t.originalEvent.touches[0].pageX : t.pageX;
            ...
            n.initTouch(), n.listenClick(n.$rating, function (t) {
                ...
                var t, e, r;
                n.hoverEnabled && !n.inactive && n.hoverOnClear && (n.clearClicked = !1, t = '<span class="' + n.clearCaptionClass + '">' + n.clearCaption + "</span>", e = n.clearValue, r = n.getWidthFromValue(e), a = {
                    caption: t,
                    width: r,
                    val: e
            ...
            var a, n, i, l, o, s, c, u = this, g = "ontouchstart"in window || window.DocumentTouch && document instanceof window.DocumentTouch;
            g && !u.inactive && (a = t.originalEvent, n = r(a.touches) ? a.changedTouches : a.touches, i = u.getPosition(n[0]), e ? (u.setStars(i), u.$element.trigger("change").trigger("rating.change", [u.$element.val(), u.$caption.html()]), u.starClicked = !0) : (l = u.calculate(i), o = l.val <= u.clearValue ? u.fetchCaption(u.clearValue) : l.caption, s = u.getWidthFromValue(u.clearValue), c = l.val <= u.clearValue ? u.rtl ? 100 - s + "%" : s + "%" : l.width, u.$caption.html(o), u.$stars.css("width", c)))
        }, initTouch: function () {
            var t = this;
        ...
        switch (a.shift(), this.each(function () {
            var i, l = t(this), o = l.data("rating"), s = "object" == typeof e && e, u = s.language || l.data("language") || "en";
            o || (i = t.extend({}, t.fn.rating.defaults), "en" === u || r(t.fn.ratingLocales[u]) || (i = t.extend(i, t.fn.ratingLocales[u])), o = new c(this, t.extend(i, s, l.data())), l.data("rating", o)), "string" == typeof e && n.push(o[e].apply(o, a))
        }), n.length) {
            case 0:
                return this;
            case 1:
    ...
    }, t.extend(t.fn.rating.defaults, t.fn.ratingLocales.en), t.fn.rating.Constructor = c, t("input.rating").addClass("rating-loading"), t(document).ready(function () {
