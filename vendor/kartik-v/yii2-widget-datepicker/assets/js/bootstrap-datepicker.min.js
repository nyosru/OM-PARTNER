...
!function (t) {
    ...
    function o(e, a) {
        ...
        var s, n = t(e).data(), r = {}, o = new RegExp("^" + a.toLowerCase() + "([A-Z])");
    ...
    var l = function () {
        var e = {
            get: function (t) {
                ...
                for (var e = t && t.valueOf(), a = 0, i = this.length; i > a; a++)if (this[a].valueOf() === e)return a;
                return -1
            }, remove: function (t) {
                this.splice(t, 1)
            }, replace: function (e) {
    ...
    d.prototype = {
        constructor: d, _process_options: function (s) {
            ...
            n.startView = Math.min(n.startView, n.maxViewMode), n.startView = Math.max(n.startView, n.minViewMode), n.multidate !== !0 && (n.multidate = Number(n.multidate) || !1, n.multidate !== !1 && (n.multidate = Math.max(0, n.multidate))), n.multidateSeparator = String(n.multidateSeparator), n.weekStart %= 7, n.weekEnd = (n.weekStart + 6) % 7;
            ...
            if (n.startDate !== -(1 / 0) && (n.startDate ? n.startDate instanceof Date ? n.startDate = this._local_to_utc(this._zero_time(n.startDate)) : n.startDate = m.parseDate(n.startDate, o, n.language) : n.startDate = -(1 / 0)), n.endDate !== 1 / 0 && (n.endDate ? n.endDate instanceof Date ? n.endDate = this._local_to_utc(this._zero_time(n.endDate)) : n.endDate = m.parseDate(n.endDate, o, n.language) : n.endDate = 1 / 0), n.daysOfWeekDisabled = n.daysOfWeekDisabled || [], t.isArray(n.daysOfWeekDisabled) || (n.daysOfWeekDisabled = n.daysOfWeekDisabled.split(/[,\s]*/)), n.daysOfWeekDisabled = t.map(n.daysOfWeekDisabled, function (t) {
                ...
                }), n.daysOfWeekHighlighted = n.daysOfWeekHighlighted || [], t.isArray(n.daysOfWeekHighlighted) || (n.daysOfWeekHighlighted = n.daysOfWeekHighlighted.split(/[,\s]*/)), n.daysOfWeekHighlighted = t.map(n.daysOfWeekHighlighted, function (t) {
                    return parseInt(t, 10)
                }), n.datesDisabled = n.datesDisabled || [], !t.isArray(n.datesDisabled)) {
                var h = [];
                h.push(m.parseDate(n.datesDisabled, o, n.language)), n.datesDisabled = h
            }
            n.datesDisabled = t.map(n.datesDisabled, function (t) {
                return m.parseDate(t, o, n.language)
            });
            var l = String(n.orientation).toLowerCase().split(/\s+/g), d = n.orientation.toLowerCase();
            if (l = t.grep(l, function (t) {
                    return /^auto|left|right|top|bottom$/.test(t)
                }), n.orientation = {x: "auto", y: "auto"}, d && "auto" !== d)if (1 === l.length)switch (l[0]) {
                case"top":
                case"bottom":
                    n.orientation.y = l[0];
                    break;
            ...
            }), n.orientation.y = d[0] || "auto"; else;
            if (n.defaultViewDate) {
                var c = n.defaultViewDate.year || (new Date).getFullYear(), u = n.defaultViewDate.month || 0, p = n.defaultViewDate.day || 1;
                n.defaultViewDate = a(c, u, p)
            } else n.defaultViewDate = i();
            n.showOnFocus = n.showOnFocus !== e ? n.showOnFocus : !0, n.zIndexOffset = n.zIndexOffset !== e ? n.zIndexOffset : 10
            ...
            var i = a || this.dates.get(-1), s = this._utc_to_local(i);
            ...
            var e = this.element.is("input") ? this.element : this.element.find("input.krajee-datepicker");
            ...
            var a;
            if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.types && -1 !== t.inArray("text/plain", e.originalEvent.clipboardData.types))a = e.originalEvent.clipboardData.getData("text/plain"); else {
        ...
        }, setDate: n("setDates"), setUTCDate: n("setUTCDates"), setValue: function () {
            ...
            var e = this.picker.outerWidth(), a = this.picker.outerHeight(), i = 10, s = t(this.o.container), n = s.width(), r = s.scrollTop(), o = s.offset(), h = [];
            this.element.parents().each(function () {
                var e = t(this).css("z-index");
                "auto" !== e && 0 !== e && h.push(parseInt(e))
            });
            var l = Math.max.apply(Math, h) + this.o.zIndexOffset, d = this.component ? this.component.parent().offset() : this.element.offset(), c = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1), u = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), p = d.left - o.left, f = d.top - o.top;
            this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"), "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (p -= e - u)) : d.left < 0 ? (this.picker.addClass("datepicker-orient-left"), p -= d.left - i) : p + e > n ? (this.picker.addClass("datepicker-orient-right"), p = d.left + u - e) : this.picker.addClass("datepicker-orient-left");
            var g, D = this.o.orientation.y;
            if ("auto" === D && (g = -r + f - a, D = 0 > g ? "bottom" : "top"), this.picker.addClass("datepicker-orient-" + D), "top" === D ? f -= a + parseInt(this.picker.css("padding-top")) : f += c, this.o.rtl) {
                var m = n - (p + u);
            ...
            }, this), !0), this.dates.replace(a), this.dates.length ? this.viewDate = new Date(this.dates.get(-1)) : this.viewDate < this.o.startDate ? this.viewDate = new Date(this.o.startDate) : this.viewDate > this.o.endDate ? this.viewDate = new Date(this.o.endDate) : this.viewDate = this.o.defaultViewDate, i ? this.setValue() : a.length && String(e) !== String(this.dates) && this._trigger("changeDate"), !this.dates.length && e.length && this._trigger("clearDate"), this.fill(), this.element.change(), this
        }, fillDow: function () {
            ...
            for (this.o.calendarWeeks && (this.picker.find(".datepicker-days .datepicker-switch").attr("colspan", function (t, e) {
                return parseInt(e) + 1
            }), e += '<th class="cw">&#160;</th>'); t < this.o.weekStart + 7;)e += '<th class="dow">' + D[this.o.language].daysMin[t++ % 7] + "</th>";
            ...
            var a = [], i = this.viewDate.getUTCFullYear(), n = this.viewDate.getUTCMonth(), r = new Date;
            return e.getUTCFullYear() < i || e.getUTCFullYear() === i && e.getUTCMonth() < n ? a.push("old") : (e.getUTCFullYear() > i || e.getUTCFullYear() === i && e.getUTCMonth() > n) && a.push("new"), this.focusDate && e.valueOf() === this.focusDate.valueOf() && a.push("focused"), this.o.todayHighlight && e.getUTCFullYear() === r.getFullYear() && e.getUTCMonth() === r.getMonth() && e.getUTCDate() === r.getDate() && a.push("today"), -1 !== this.dates.contains(e) && a.push("active"), (e.valueOf() < this.o.startDate || e.valueOf() > this.o.endDate || -1 !== t.inArray(e.getUTCDay(), this.o.daysOfWeekDisabled)) && a.push("disabled"), -1 !== t.inArray(e.getUTCDay(), this.o.daysOfWeekHighlighted) && a.push("highlighted"), this.o.datesDisabled.length > 0 && t.grep(this.o.datesDisabled, function (t) {
                return s(e, t)
            }).length > 0 && a.push("disabled", "disabled-date"), this.range && (e > this.range[0] && e < this.range[this.range.length - 1] && a.push("range"), -1 !== t.inArray(e.valueOf(), this.range) && a.push("selected"), e.valueOf() === this.range[0] && a.push("range-start"), e.valueOf() === this.range[this.range.length - 1] && a.push("range-end")), a
        }, fill: function () {
            var i, s = new Date(this.viewDate), n = s.getUTCFullYear(), r = s.getUTCMonth(), o = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCFullYear() : -(1 / 0), h = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCMonth() : -(1 / 0), l = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, d = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, c = D[this.o.language].today || D.en.today || "", u = D[this.o.language].clear || D.en.clear || "", p = D[this.o.language].titleFormat || D.en.titleFormat;
            if (!isNaN(n) && !isNaN(r)) {
                this.picker.find(".datepicker-days thead .datepicker-switch").text(m.formatDate(new a(n, r), p, this.o.language)), this.picker.find("tfoot .today").text(c).toggle(this.o.todayBtn !== !1), this.picker.find("tfoot .clear").text(u).toggle(this.o.clearBtn !== !1), this.picker.find("thead .datepicker-title").text(this.o.title).toggle("" !== this.o.title), this.updateNavArrows(), this.fillMonths();
                var f = a(n, r - 1, 28), g = m.getDaysInMonth(f.getUTCFullYear(), f.getUTCMonth());
                f.setUTCDate(g), f.setUTCDate(g - (f.getUTCDay() - this.o.weekStart + 7) % 7);
                var v = new Date(f);
                f.getUTCFullYear() < 100 && v.setUTCFullYear(f.getUTCFullYear()), v.setUTCDate(v.getUTCDate() + 42), v = v.valueOf();
                for (var y, w = []; f.valueOf() < v;) {
                    if (f.getUTCDay() === this.o.weekStart && (w.push("<tr>"), this.o.calendarWeeks)) {
                        var k = new Date(+f + (this.o.weekStart - f.getUTCDay() - 7) % 7 * 864e5), C = new Date(Number(k) + (11 - k.getUTCDay()) % 7 * 864e5), b = new Date(Number(b = a(C.getUTCFullYear(), 0, 1)) + (11 - b.getUTCDay()) % 7 * 864e5), T = (C - b) / 864e5 / 7 + 1;
                    ...
                    if (y = this.getClassNames(f), y.push("day"), this.o.beforeShowDay !== t.noop) {
                        ...
                        _ === e ? _ = {} : "boolean" == typeof _ ? _ = {enabled: _} : "string" == typeof _ && (_ = {classes: _}), _.enabled === !1 && y.push("disabled"), _.classes && (y = y.concat(_.classes.split(/\s+/))), _.tooltip && (i = _.tooltip)
                    }
                    y = t.unique(y), w.push('<td class="' + y.join(" ") + '"' + (i ? ' title="' + i + '"' : "") + ">" + f.getUTCDate() + "</td>"), i = null, f.getUTCDay() === this.o.weekEnd && w.push("</tr>"), f.setUTCDate(f.getUTCDate() + 1)
                }
                ...
                if (t.each(this.dates, function (t, e) {
                    ...
                    }), (o > n || n > l) && M.addClass("disabled"), n === o && M.slice(0, h).addClass("disabled"), n === l && M.slice(d + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                    var U = this;
                    t.each(M, function (e, a) {
                        if (!t(a).hasClass("disabled")) {
                            var i = new Date(n, e, 1), s = U.o.beforeShowMonth(i);
                            s === !1 && t(a).addClass("disabled")
                        }
                    })
                }
                w = "", n = 10 * parseInt(n / 10, 10);
                ...
                for (var F, Y = t.map(this.dates, function (t) {
                    ...
                    if (F = ["year"], i = null, -1 === S ? F.push("old") : 10 === S && F.push("new"), -1 !== t.inArray(n, Y) && F.push("active"), (o > n || n > l) && F.push("disabled"), this.o.beforeShowYear !== t.noop) {
                        var O = this.o.beforeShowYear(new Date(n, 0, 1));
                        O === e ? O = {} : "boolean" == typeof O ? O = {enabled: O} : "string" == typeof O && (O = {classes: O}), O.enabled === !1 && F.push("disabled"), O.classes && (F = F.concat(O.classes.split(/\s+/))), O.tooltip && (i = O.tooltip)
                    }
                    w += '<span class="' + F.join(" ") + '"' + (i ? ' title="' + i + '"' : "") + ">" + n + "</span>", n += 1
                }
                x.html(w)
            }
            ...
            if (this._allow_update) {
                ...
                switch (this.viewMode) {
                    case 0:
                        this.picker.find(".prev").css(this.o.startDate !== -(1 / 0) && e <= this.o.startDate.getUTCFullYear() && a <= this.o.startDate.getUTCMonth() ? {visibility: "hidden"} : {visibility: "visible"}), this.picker.find(".next").css(this.o.endDate !== 1 / 0 && e >= this.o.endDate.getUTCFullYear() && a >= this.o.endDate.getUTCMonth() ? {visibility: "hidden"} : {visibility: "visible"});
                        break;
                    case 1:
                    case 2:
                        this.picker.find(".prev").css(this.o.startDate !== -(1 / 0) && e <= this.o.startDate.getUTCFullYear() || this.o.maxViewMode < 2 ? {visibility: "hidden"} : {visibility: "visible"}), this.picker.find(".next").css(this.o.endDate !== 1 / 0 && e >= this.o.endDate.getUTCFullYear() || this.o.maxViewMode < 2 ? {visibility: "hidden"} : {visibility: "visible"})
                }
            }
        }, click: function (e) {
            ...
            if (!e)return t;
            var a, i, s = new Date(t.valueOf()), n = s.getUTCDate(), o = s.getUTCMonth(), h = Math.abs(e);
            if (e = e > 0 ? 1 : -1, 1 === h)i = -1 === e ? function () {
                return s.getUTCMonth() === o
            } : function () {
                return s.getUTCMonth() !== a
            }, a = o + e, s.setUTCMonth(a), (0 > a || a > 11) && (a = (a + 12) % 12); else {
            ...
            var e, a, s, n = !1, r = this.focusDate || this.viewDate;
            switch (t.keyCode) {
                case 27:
            ...
            t && (this.viewMode = Math.max(this.o.minViewMode, Math.min(this.o.maxViewMode, this.viewMode + t))), this.picker.children("div").hide().filter(".datepicker-" + m.modes[this.viewMode].clsName).show(), this.updateNavArrows()
        }
    };
    var c = function (e, a) {
        this.element = t(e), this.inputs = t.map(a.inputs, function (t) {
            return t.jquery ? t[0] : t
        }), delete a.inputs, p.call(t(this.inputs), a).on("changeDate", t.proxy(this.dateUpdated, this)), this.pickers = t.map(this.inputs, function (e) {
        ...
        updateDates: function () {
            ...
            if (!this.updating) {
                ...
                if ("undefined" != typeof a) {
                    var i = a.getUTCDate(), s = t.inArray(e.target, this.inputs), n = s - 1, r = s + 1, o = this.inputs.length;
                    if (-1 !== s) {
                        if (t.each(this.pickers, function (t, e) {
                                e.getUTCDate() || e.setUTCDate(i)
                            }), i < this.dates[n])for (; n >= 0 && i < this.dates[n];)this.pickers[n--].setUTCDate(i); else if (i > this.dates[r])for (; o > r && i > this.dates[r];)this.pickers[r++].setUTCDate(i);
    ...
    var u = t.fn.datepicker, p = function (a) {
        var i = Array.apply(null, arguments);
        i.shift();
        var s;
        if (this.each(function () {
                var e = t(this), n = e.data("datepicker"), r = "object" == typeof a && a;
                if (!n) {
                    var l = o(this, "date"), u = t.extend({}, f, l, r), p = h(u.language), g = t.extend({}, f, p, l, r);
                    if (e.hasClass("input-daterange") || g.inputs) {
                        var D = {inputs: g.inputs || e.find("input").toArray()};
                        e.data("datepicker", n = new c(this, t.extend(g, D)))
                    } else e.data("datepicker", n = new d(this, g))
                }
                "string" == typeof a && "function" == typeof n[a] && (s = n[a].apply(n, i))
    ...
    var D = t.fn.datepicker.dates = {
        ...
        parseFormat: function (t) {
            ...
            var e = t.replace(this.validParts, "\x00").split("\x00"), a = t.match(this.validParts);
        ...
        parseDate: function (i, s, n) {
            ...
            var o, h, l, c = /([\-+]\d+)([dmwy])/, u = i.match(/([\-+]\d+)([dmwy])/g);
            if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(i)) {
                for (i = new Date, l = 0; l < u.length; l++)switch (o = c.exec(u[l]), h = parseInt(o[1]), o[2]) {
                    case"d":
                        i.setUTCDate(i.getUTCDate() + h);
                        break;
                    case"m":
                        i = d.prototype.moveMonth.call(d.prototype, i, h);
                        break;
                    case"w":
                        i.setUTCDate(i.getUTCDate() + 7 * h);
                        break;
                    case"y":
                        i = d.prototype.moveYear.call(d.prototype, i, h)
                }
                return a(i.getUTCFullYear(), i.getUTCMonth(), i.getUTCDate(), 0, 0, 0)
            }
            u = i && i.match(this.nonpunctuation) || [], i = new Date;
            var p, f, g = {}, v = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], y = {
                yyyy: function (t, e) {
            ...
            if (u.length !== w.length && (w = t(w).filter(function (e, a) {
                ...
                for (l = 0, k = w.length; k > l; l++) {
                    if (p = parseInt(u[l], 10), o = w[l], isNaN(p))switch (o) {
                        case"MM":
                            f = t(D[n].months).filter(r), p = t.inArray(f[0], D[n].months) + 1;
                            break;
                        case"M":
                            f = t(D[n].monthsShort).filter(r), p = t.inArray(f[0], D[n].monthsShort) + 1
                    }
                    g[o] = p
                }
                var C, b;
                for (l = 0; l < v.length; l++)b = v[l], b in g && !isNaN(g[b]) && (C = new Date(i), y[b](C, g[b]), isNaN(C) || (i = C))
            }
            return i
        },
        formatDate: function (e, a, i) {
            if (!e)return "";
            if ("string" == typeof a && (a = m.parseFormat(a)), a.toDisplay)return a.toDisplay(e, a, i);
            var s = {
                d: e.getUTCDate(),
    ...
    }, t.fn.datepicker.version = "1.5.0", t(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]', function (e) {
        var a = t(this);
        a.data("datepicker") || (e.preventDefault(), p.call(a, "show"))
    }), t(function () {
